...
{
  "$end", "error", "$undefined", "numero", "cadena", "ruta", "montar",
  "Tigual", "Tguion", "identificador", "$accept", "INICIO", "L_COMANDO",
  "COMANDO", "L_PARAMETRO", "PARAMETRO", YY_NULLPTR
};
#endif
...
#line 57 "parser.y" /* yacc.c:1646  */
    {
        raiz = new Nodo((yylsp[0]).first_line, (yylsp[0]).first_column,"S","S");
        raiz=(yyvsp[0].nodo);
    }
